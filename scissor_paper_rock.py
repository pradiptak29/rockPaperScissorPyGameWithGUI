...
lbl1 = Label(opening_window, text="  Hello, I'm Jarvis. Do you want to play?  ", font=('calibre', 12, 'bold'), bg="#7e1ab8", fg="#c3d408")
...
def clicked():
    ...
    lbl2 = Label(opening_window, text="    Please Enter an User Name Below    ", font=('calibre', 12, 'bold'), bg="#7e1ab8", fg="#c3d408")
...
play_btn_no.grid(column=1, row=4)
